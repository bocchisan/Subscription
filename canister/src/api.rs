//! The Candid surface. Updates are exactly the frozen allowlist; all of them
//! permissionless — the right is the derivation arithmetic and the schedule,
//! never who sends the call. `request_cancel` arrives at G3.
